...
Capture rate     = N_valorized / (N_valorized + N_rejected) × 100
Cu yield         = Cu_mass_final / Cu_mass_initial × 100
Heat recovery    = η_exchanger × m × Cp × ΔT / 3600
Net energy       = Gross_energy - Recovered_heat
Economic value   = Cu_mass × 8.5 + Au_mass × 60 + Ag_mass × 0.8
```

---

*WEEE Digital Twin project glossary*
